...
<qgis simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" minScale="100000000" simplifyAlgorithm="0" readOnly="1" styleCategories="AllStyleCategories" simplifyDrawingHints="0" version="3.22.10-Białowieża" maxScale="0" labelsEnabled="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0">
  ...
  <renderer-v2 enableorderby="0" symbollevels="0" forceraster="0" type="RuleRenderer" referencescale="-1">
    <rules key="{b3673f97-b143-43a9-bd4b-11a8bd363d47}">
      <rule key="{55e3dad8-5e69-490f-92b7-8c3f3915dbad}" label="Not Completed" symbol="0" filter="complete='False'"/>
      <rule key="{ecce678b-bb67-4047-bcd3-cd37909198b2}" label="Not Connected" symbol="1" filter="complete='True' and start_segments is NULL and end_segments is NULL"/>
      <rule key="{d8c3eddf-884d-4b16-859c-79a5a51d7790}" label="Partially Connected" symbol="2" filter="complete='True' and ((start_segments is NULL and end_segments is not NULL) or (start_segments is not NULL and end_segments is NULL))"/>
      <rule key="{e47c924b-14a3-44ad-a99f-44b810d39748}" label="Fully Connected" symbol="3" filter="complete='True' and start_segments is not NULL and end_segments is not NULL"/>
      <rule key="{0de0ab13-510b-42f9-a61e-d3ee751daba3}" label="Anchor Boundary" symbol="4" filter="anchor_wu_ids &lt;> ''"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" name="2" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="255,165,0,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="0.7" k="line_width"/>
          <prop v="MM" k="line_width_unit"/>
          <prop v="0" k="offset"/>
      ...
      <symbol force_rhr="0" name="3" type="line" alpha="0.6" clip_to_extent="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol force_rhr="0" name="4" type="line" alpha="1" clip_to_extent="1">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="3;10" name="customdash" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="customdash_map_unit_scale" type="QString"/>
            <Option value="MM" name="customdash_unit" type="QString"/>
            <Option value="0" name="dash_pattern_offset" type="QString"/>
            <Option value="3x:0,0,0,0,0,0" name="dash_pattern_offset_map_unit_scale" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="" fontUnderline="0" fieldName="boundary_id" previewBkgrdColor="255,255,255,255" allowHtml="0" fontSize="10" fontFamily="Arial" isExpression="0" capitalization="0" fontStrikeout="0" useSubstitutions="0" legendString="Aa" multilineHeight="1" fontWordSpacing="0" textOpacity="1" fontKerning="1" textOrientation="horizontal" blendMode="0" fontLetterSpacing="0" textColor="0,0,0,255" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontSizeUnit="Point">
        <families/>
  ...
  <referencedLayers>
    <relation id="2052774372688-2052774372400-boundary_id-boundary_id" referencedLayer="Boundary_Points_ae46ecb7_c3e1_4724_b5ff_e2f19811b23a" referencingLayer="Boundary_Planes_ac16c0fe_0c2a_47be_a111_e807c7f14fba" providerKey="memory" layerId="Boundary_Points_ae46ecb7_c3e1_4724_b5ff_e2f19811b23a" strength="Association" name="boundary_id Feature" layerName="Boundary Points" dataSource="Point?crs=epsg:4326&amp;field=boundary_id:integer&amp;field=boundary_point_id:integer&amp;field=complete:string&amp;field=start_delineators:string&amp;field=end_delineators:string&amp;uid={2b6f3e36-fe24-4c13-b542-a7d5995b55c6}">
      <fieldRef referencingField="boundary_id" referencedField="boundary_id"/>
    </relation>
  </referencedLayers>
  <fieldConfiguration>
    <field name="boundary_id" configurationFlags="None">
    ...
    <field name="complete" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="wu_ids" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="anchor_wu_ids" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="start_segments" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
    ...
    <field name="end_segments" configurationFlags="None">
      <editWidget type="">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    <alias field="boundary_id" name="" index="0"/>
    <alias field="complete" name="" index="1"/>
    <alias field="wu_ids" name="" index="2"/>
    <alias field="anchor_wu_ids" name="" index="3"/>
    <alias field="start_segments" name="" index="4"/>
    <alias field="end_segments" name="" index="5"/>
  </aliases>
  <defaults>
    <default expression="" field="boundary_id" applyOnUpdate="0"/>
    <default expression="" field="complete" applyOnUpdate="0"/>
    <default expression="" field="wu_ids" applyOnUpdate="0"/>
    <default expression="" field="anchor_wu_ids" applyOnUpdate="0"/>
    <default expression="" field="start_segments" applyOnUpdate="0"/>
    <default expression="" field="end_segments" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint field="boundary_id" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="complete" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="wu_ids" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="anchor_wu_ids" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="start_segments" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="end_segments" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="boundary_id" desc="" exp=""/>
    <constraint field="complete" desc="" exp=""/>
    <constraint field="wu_ids" desc="" exp=""/>
    <constraint field="anchor_wu_ids" desc="" exp=""/>
    <constraint field="start_segments" desc="" exp=""/>
    <constraint field="end_segments" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributeEditorForm>
    <attributeEditorField showLabel="1" name="boundary_id" index="0"/>
    <attributeEditorField showLabel="1" name="complete" index="1"/>
    <attributeEditorField showLabel="1" name="wu_ids" index="2"/>
    <attributeEditorField showLabel="1" name="anchor_wu_ids" index="3"/>
    <attributeEditorField showLabel="1" name="start_segments" index="4"/>
    <attributeEditorField showLabel="1" name="end_segments" index="5"/>
  </attributeEditorForm>
  <editable/>
  <labelOnTop/>
  <reuseLastValue/>
  ...
  <widgets/>
  <previewExpression>"boundary_id"</previewExpression>
  <mapTip></mapTip>
